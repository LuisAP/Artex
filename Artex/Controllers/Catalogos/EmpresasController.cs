...
namespace Artex.Controllers.Catalogos
{
    ...
    {
        private const string ABSOLUTE_PATH = "~/Views/Catalogos/Empresas.cshtml";
        ...
        public ActionResult GetAlls()
        {
            ...
            List<empresa> consulta = dao.GetAlls();
        ...
        [HttpPost]
        public JsonResult Guardar(EmpresaModel model)
        {
