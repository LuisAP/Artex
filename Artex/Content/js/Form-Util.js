    ...
    $("body").on('click', 'button', function () {
        ...
        form.ajaxSubmit({
            ...
            success: function (r) {
                ...
                error:function () {
                    var message = '<div class="alert ' + "alert-danger" + ' alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + "Error, es posible que no tenga conexion con el servidor" + '</div>';
                    form.prepend(message);
                    block.remove();
                }
        });
